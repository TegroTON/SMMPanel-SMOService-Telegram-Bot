...
Замените 'путь до рабочей директории' на реальный путь до директории, где расположен файл main.py.
Замените 'имя пользователя' на имя пользователя, от лица которого должен запускаться бот.
Сохраните и закройте файл.
